    ...
    g("0", [], function () {
        return function (a) {
            function b() {
                ...
                function b(b) {
                    var c, d = this;
                    if (null != b) a.call(d), d.each(function (a, c) {
                        var d;
                ...
                f.each(["text", "html", "val"], function (a, g) {
                    ...
                    f.fn[g] = function (a) {
                        ...
                        var h = "",
                            k = arguments;
                        return (j ? g : g.eq(0)).each(function (a, b) {
                            var c = d(b);
                            h += c ? j ? c.getContent().replace(/<(?:"[^"]*"|'[^']*'|[^'">])*>/g, "") : c.getContent({
                                save: !0
                            }) : i.apply(f(b), k)
                        }), h
                    }
                    ...
                    f.fn[b] = function (a) {
                        var b = this;
                        return e(b) ? a !== c ? ("string" == typeof a && b.filter(":tinymce").each(function (b, c) {
                            var e = d(c);
            ...
            f.fn.tinymce = function (a) {
                function c() {
                    var c = [],
                        d = 0;
                    e || (b(), e = !0), m.each(function (b, e) {
                        var f, g = e.id,
                            h = a.oninit;
                        g || (e.id = g = i().DOM.uniqueId()), i().get(g) || (f = i().createEditor(g, a), c.push(f), f.on("init", function () {
                            var a, b = h;
                            m.css("visibility", ""), h && ++d == c.length && ("string" == typeof b && (a = b.indexOf(".") === -1 ? null : i().resolve(b.replace(/\.\w+$/, "")), b = i().resolve(b)), b.apply(a || i(), c))
                        }))
                ...
                if (m.css("visibility", "hidden"), g.tinymce || d || !(j = a.script_url)) 1 === d ? h.push(c) : c();
                    ...
                    d = 1, k = j.substring(0, j.lastIndexOf("/")), j.indexOf(".min") != -1 && (n = ".min"), g.tinymce = g.tinyMCEPreInit || {
                        base: k,
                        suffix: n
                    }, j.indexOf("gzip") != -1 && (l = a.language || "en", j = j + (/\?/.test(j) ? "&" : "?") + "js=true&core=true&suffix=" + escape(n) + "&themes=" + escape(a.theme || "modern") + "&plugins=" + escape(a.plugins || "") + "&languages=" + (l || ""), g.tinyMCE_GZ || (g.tinyMCE_GZ = {
                        start: function () {
                            function b(a) {
                    ...
                    o.type = "text/javascript", o.onload = o.onreadystatechange = function (b) {
